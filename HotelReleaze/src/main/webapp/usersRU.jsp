    ...
    <div class="header">
        <div class="mid">
            <header class="logo">
                <div class="topmenu">
                    <aside >
                        <input type="submit" name="bookClick" value="Забронированные" class="mainBtn"/>
                        <input type="submit" name="exitClick" value="Выход" class="mainBtn"/>
                        <input type="submit" name="changeMyUsersClick" value="Русский" class="mainBtn"/>
                        <img src="img/Russia.png" all="Russian" width="40" height="40">
                    </aside>
    ...
    <div class="footer">
        <div class="mid">
            <div class="fon">
                    ...
                    <table>
                        <tr>
                            <th>№</th><th>Логин</th><th>Пароль</th><th>Права</th>
                        </tr>
